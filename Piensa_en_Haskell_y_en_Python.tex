...
\section{TAD de las colas: Todos los elementos verifican una propiedad}
\subsection{En Haskell}
\haskell{TodosVerifican}
\subsection{En Python}
\python{todosVerifican}

\section{TAD de las colas: Alguno de los elementos verifican una propiedad}
\subsection{En Haskell}
\haskell{AlgunoVerifica}
\subsection{En Python}
\python{algunoVerifica}

\section{TAD de las colas: Extensión de colas}
\subsection{En Haskell}
\haskell{ExtiendeCola}
\subsection{En Python}
\python{extiendeCola}

\section{TAD de las colas: Intercalado de dos colas}
\subsection{En Haskell}
\haskell{IntercalaColas}
\subsection{En Python}
\python{intercalaColas}

\section{TAD de las colas: Agrupación de colas}
\subsection{En Haskell}
\haskell{AgrupaColas}
\subsection{En Python}
\python{agrupaColas}
