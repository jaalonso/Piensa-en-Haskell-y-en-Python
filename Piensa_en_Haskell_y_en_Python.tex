...
\subsection{En Haskell}
\haskell{Programacion_dinamica_Caminos_en_una_reticula}
\subsection{En Python}
\python{Programacion_dinamica_Caminos_en_una_reticula}

\section{Caminos en una matriz (con programación dinámica)}
\subsection{En Haskell}
\haskell{Caminos_en_una_matriz}
\subsection{En Python}
\python{Caminos_en_una_matriz}

\section{Máxima suma de los caminos en una matriz}
\subsection{En Haskell}
\haskell{Maxima_suma_de_los_caminos_en_una_matriz}
\subsection{En Python}
\python{Maxima_suma_de_los_caminos_en_una_matriz}

\section{Camino de máxima suma en una matriz}
\subsection{En Haskell}
\haskell{Camino_de_maxima_suma_en_una_matriz}
\subsection{En Python}
\python{Camino_de_maxima_suma_en_una_matriz}
...
\subsection{En Haskell}
\haskell{Metodo_de_Heron_para_calcular_la_raiz_cuadrada}
\subsection{En Python}
\python{Metodo_de_Heron_para_calcular_la_raiz_cuadrada}

\section{Método de Newton para calcular raíces}
\subsection{En Haskell}
\haskell{Metodo_de_Newton_para_calcular_raices}
\subsection{En Python}
\python{Metodo_de_Newton_para_calcular_raices}

\section{Funciones inversas por el método de Newton}
\subsection{En Haskell}
\haskell{Funciones_inversas_por_el_metodo_de_Newton}
\subsection{En Python}
\python{Funciones_inversas_por_el_metodo_de_Newton}

\section{Límites de sucesiones}
\subsection{En Haskell}
\haskell{Limites_de_sucesiones}
\subsection{En Python}
\python{Limites_de_sucesiones}

\section{Método de bisección para calcular ceros de una función}
\subsection{En Haskell}
\haskell{Metodo_de_biseccion_para_calcular_ceros_de_una_funcion}
\subsection{En Python}
\python{Metodo_de_biseccion_para_calcular_ceros_de_una_funcion}

\section{Raíces enteras}
\subsection{En Haskell}
\haskell{Raices_enteras}
\subsection{En Python}
\python{Raices_enteras}

\section{Integración por el método de los rectángulos}
\subsection{En Haskell}
\haskell{Integracion_por_rectangulos}
\subsection{En Python}
\python{Integracion_por_rectangulos}

\section{Algoritmo de bajada para resolver un sistema triangular inferior}
\subsection{En Haskell}
\haskell{Algoritmo_de_bajada}
\subsection{En Python}
\python{Algoritmo_de_bajada}
...
\subsection{En Haskell}
\haskell{Numeros_de_Pentanacci}
\subsection{En Python}
\python{Numeros_de_Pentanacci}

\section{El teorema de Navidad de Fermat}
\subsection{En Haskell}
\haskell{El_teorema_de_Navidad_de_Fermat}
\subsection{En Python}
\python{El_teorema_de_Navidad_de_Fermat}

\section{Números primos de Hilbert}
\subsection{En Haskell}
\haskell{Numeros_primos_de_Hilbert}
\subsection{En Python}
\python{Numeros_primos_de_Hilbert}

\section{Factorizaciones de números de Hilbert}
\subsection{En Haskell}
\haskell{Factorizaciones_de_numeros_de_Hilbert}
\subsection{En Python}
\python{Factorizaciones_de_numeros_de_Hilbert}

\section{Sumas de dos primos}
\subsection{En Haskell}
\haskell{Sumas_de_dos_primos}
\subsection{En Python}
\python{Sumas_de_dos_primos}

\section{Representaciones de un número como suma de dos cuadrados}
\subsection{En Haskell}
\haskell{Representaciones_de_un_numero_como_suma_de_dos_cuadrados}
\subsection{En Python}
\python{Representaciones_de_un_numero_como_suma_de_dos_cuadrados}

\section{La serie de Thue-Morse}
\subsection{En Haskell}
\haskell{La_serie_de_Thue_Morse}
\subsection{En Python}
\python{La_serie_de_Thue_Morse}

\section{La sucesión de Thue-Morse}
\subsection{En Haskell}
\haskell{La_sucesion_de_Thue_Morse}
\subsection{En Python}
\python{La_sucesion_de_Thue_Morse}

\section{Huecos maximales entre primos}
\subsection{En Haskell}
\haskell{Huecos_maximales_entre_primos}
\subsection{En Python}
\python{Huecos_maximales_entre_primos}

\section{La función indicatriz de Euler}
\subsection{En Haskell}
\haskell{La_funcion_indicatriz_de_Euler}
\subsection{En Python}
\python{La_funcion_indicatriz_de_Euler}

\section{Ceros finales del factorial}
\subsection{En Haskell}
\haskell{Ceros_finales_del_factorial}
\subsection{En Python}
\python{Ceros_finales_del_factorial}

\section{Primos cubanos}
\subsection{En Haskell}
\haskell{Primos_cubanos}
\subsection{En Python}
\python{Primos_cubanos}

\section{Cuadrado más cercano}
\subsection{En Haskell}
\haskell{Cuadrado_mas_cercano}
\subsection{En Python}
\python{Cuadrado_mas_cercano}

\section{Suma de cadenas}
\subsection{En Haskell}
\haskell{Suma_de_cadenas}
\subsection{En Python}
\python{Suma_de_cadenas}

\section{Sistema factorádico de numeración}
\subsection{En Haskell}
\haskell{Sistema_factoradico_de_numeracion}
\subsection{En Python}
\python{Sistema_factoradico_de_numeracion}

\section{Duplicación de cada elemento}
\subsection{En Haskell}
\haskell{Duplicacion_de_cada_elemento}
\subsection{En Python}
\python{Duplicacion_de_cada_elemento}

\section{Suma de fila del triángulo de los impares}
\subsection{En Haskell}
\haskell{Suma_de_fila_del_triangulo_de_los_impares}
\subsection{En Python}
\python{Suma_de_fila_del_triangulo_de_los_impares}

\section{Reiteración de suma de consecutivos}
\subsection{En Haskell}
\haskell{Reiteracion_de_suma_de_consecutivos}
\subsection{En Python}
\python{Reiteracion_de_suma_de_consecutivos}

\section{Producto de los elementos de la diagonal principal}
\subsection{En Haskell}
\haskell{Producto_de_los_elementos_de_la_diagonal_principal}
\subsection{En Python}
\python{Producto_de_los_elementos_de_la_diagonal_principal}

\section{Reconocimiento de potencias de 4}
\subsection{En Haskell}
\haskell{Reconocimiento_de_potencias_de_4}
\subsection{En Python}
\python{Reconocimiento_de_potencias_de_4}

\section{Exponente en la factorización}
\subsection{En Haskell}
\haskell{Exponente_en_la_factorizacion}
\subsection{En Python}
\python{Exponente_en_la_factorizacion}

\section{Mayor órbita de la sucesión de Collatz}
\subsection{En Haskell}
\haskell{Mayor_orbita_de_la_sucesion_de_Collatz}
\subsection{En Python}
\python{Mayor_orbita_de_la_sucesion_de_Collatz}

\section{Máximos locales}
\subsection{En Haskell}
\haskell{Maximos_locales}
\subsection{En Python}
\python{Maximos_locales}

\section{Caminos en un triángulo}
\subsection{En Haskell}
\haskell{Caminos_en_un_triangulo}
\subsection{En Python}
\python{Caminos_en_un_triangulo}

\section{Máxima suma de caminos en un triángulo}
\subsection{En Haskell}
\haskell{Maxima_suma_de_caminos_en_un_triangulo}
\subsection{En Python}
\python{Maxima_suma_de_caminos_en_un_triangulo}

\section{Números amigos}
\subsection{En Haskell}
\haskell{Numeros_amigos}
\subsection{En Python}
\python{Numeros_amigos}

\section{Primos equidistantes}
\subsection{En Haskell}
\haskell{Primos_equidistantes}
\subsection{En Python}
\python{Primos_equidistantes}

\section{Numeración de ternas de naturales}
\subsection{En Haskell}
\haskell{Numeracion_de_ternas}
\subsection{En Python}
\python{Numeracion_de_ternas}

\section{Números triangulares con n cifras distintas}
\subsection{En Haskell}
\haskell{Triangulares_con_cifras}
\subsection{En Python}
\python{Triangulares_con_cifras}

\section{Posiciones de las diagonales principales}
\subsection{En Haskell}
\haskell{Posiciones_diagonales_principales}
\subsection{En Python}
\python{Posiciones_diagonales_principales}

\section{Diagonales principales de una matriz}
\subsection{En Haskell}
\haskell{Diagonales_principales}
\subsection{En Python}
\python{Diagonales_principales}

\section{Matrices de Toeplitz}
\subsection{En Haskell}
\haskell{Matriz_Toeplitz}
\subsection{En Python}
\python{Matriz_Toeplitz}

\section{Diferencia simétrica}
\subsection{En Haskell}
\haskell{Diferencia_simetrica}
\subsection{En Python}
\python{Diferencia_simetrica}

\section{Conjunto de primos relativos}
\subsection{En Haskell}
\haskell{Conjunto_de_primos_relativos}
\subsection{En Python}
\python{Conjunto_de_primos_relativos}

\section{Descomposiciones triangulares}
\subsection{En Haskell}
\haskell{Descomposiciones_triangulares}
\subsection{En Python}
\python{Descomposiciones_triangulares}
