...
\section{TAD de las pilas: Transformación entre pilas y listas}
\subsection{En Haskell}
\haskell{Transformaciones_pilas_listas}
\subsection{En Python}
\python{transformaciones_pilas_listas}

\section{TAD de las pilas: Filtrado de pilas según una propiedad}
\subsection{En Haskell}
\haskell{FiltraPila}
\subsection{En Python}
\python{filtraPila}

\section{TAD de las pilas: Aplicación de una función a los elementos de una pila}
\subsection{En Haskell}
\haskell{MapPila}
\subsection{En Python}
\python{mapPila}

\section{TAD de las pilas: Pertenencia a una pila}
\subsection{En Haskell}
\haskell{PertenecePila}
\subsection{En Python}
\python{pertenecePila}

\section{TAD de las pilas: Inclusión de pilas}
\subsection{En Haskell}
